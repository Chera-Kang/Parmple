...
# DIR (Absolute Normalized Paths)
${screenshot_DIR}     ${{os.path.abspath(os.path.join(r'${CURDIR}', '../../screenshots'))}}
${testfile_DIR}       ${{os.path.abspath(os.path.join(r'${CURDIR}', '../../common/resources/testfile'))}}
${testfile_PATH}      ${{os.path.abspath(os.path.join(r'${testfile_DIR}', 'Sameple_PDF.pdf'))}}
${bizReg_FILE}       ${{os.path.abspath(os.path.join(r'${CURDIR}', '../../common/resources/used_bizRegNo.txt'))}}
${PYTHON_EXE}        ${{os.path.abspath(os.path.join(r'${CURDIR}', '../../.venv/Scripts/python.exe'))}}
${GSHEET_READER_PY}  ${{os.path.abspath(os.path.join(r'${CURDIR}', '../../common/resources/gsheet_reader.py'))}}
${EMAIL_READER_PY}   ${{os.path.abspath(os.path.join(r'${CURDIR}', '../../common/resources/email_reader.py'))}}
${MAX_RETRY}         5
